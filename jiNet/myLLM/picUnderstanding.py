...
class get_result(object):
    def __init__(self):
        ...
        self.Secret = "NzY2YmU5YTlmODc0ZGVkYjc3NjFhMjQ5"
        # 接口APIKey（到控制台公式识别服务页面获取）
        self.APIKey = "4c521d7f98678c68279946bcd511448d"
    ...
    def get_math_problem(self, url: str):
        self.AudioPath = url
        reply = self.call_url()
        print("Scan image OK!")
        regions = reply['data']['region']
        ans = ""
        for i in regions:
            try:
                ans += (i['recog']['content'])
